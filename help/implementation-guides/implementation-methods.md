---
description: Métodos de implementación estándar y no estándar del servicio de ID de visitante.
...
Puede elegir un método de implementación del servicio de ID de visitante estándar con etiquetas o un método no estándar.
