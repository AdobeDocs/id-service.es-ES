...
Esta sección trata sobre el uso de la API para configurar Opt-in. Gran parte de la configuración y la implementación se pueden realizar mediante la extensión Launch Platform Launch.
