---
description: Estas instrucciones están destinadas a los clientes de Analytics y Audience Manager que desean utilizar el servicio de ID de visitante y no utilizan etiquetas de. Sin embargo, le recomendamos encarecidamente que utilice etiquetas para implementar el servicio de ID de visitante. Las etiquetas optimizan el flujo de trabajo de implementación y garantizan automáticamente la correcta ubicación y secuenciación del código.
keywords: Servicio de ID de visitante
title: Implementación del servicio de ID de visitante de Adobe para Analytics y Audience Manager
...
# Implementación del servicio de ID de visitante de Adobe para Analytics y Audience Manager{#implement-the-experience-cloud-id-service-for-analytics-and-audience-manager}

Estas instrucciones están destinadas a los clientes de Analytics y Audience Manager que desean utilizar el servicio de ID de visitante y no utilizan [tags](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=es). Sin embargo, le recomendamos encarecidamente que utilice etiquetas para implementar el servicio de ID de visitante. Las etiquetas optimizan el flujo de trabajo de implementación y garantizan automáticamente la correcta ubicación y secuenciación del código.
...
## Paso 9: Prueba e implementación del código de servicio de ID de visitante {#section-f857542bfc70496dbb9f318d6b3ae110}

Puede realizar pruebas e implementaciones de la siguiente manera.

**Prueba y verificación**

Para probar la implementación del servicio de ID de visitante, compruebe:
...
* Ver también [Comprobación y verificación del servicio de ID de visitante](../implementation-guides/test-verify.md).
