---
description: Estos ejemplos tratan sobre dos casos de uso habituales relacionados con una integración directa y el Experience Cloud ID (MID). El MID es una ID única y persistente para los visitantes del sitio.
keywords: ID Service
seo-description: Estos ejemplos tratan sobre dos casos de uso habituales relacionados con una integración directa y el Experience Cloud ID (MID). El MID es una ID única y persistente para los visitantes del sitio.
...
<table id="table_DA8840FCB51541109FE6DF20430E8924"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Este caso de uso supone que: </p> 
    <ul id="ul_F20231F83EE84889B78971A64E758757"> 
     <li id="li_20F3E96493724CD2BAF4B20AEE5CBF23">Tenga un MID para el visitante del sitio. Llamemos a esta ID 1234. </li> 
     <li id="li_A358C58CC58C4FCBB7250F5ED108AA71">Conozca este visitante por su propia ID única. Llamemos a esta ID 9876. </li> 
     <li id="li_D93CE7182EBE4927A5C7A0BF414C03BC">Desea vincular el MID (1234) a su propio ID único (9876). </li> 
     <li id="li_4611146E56624C2AB647733487A3F046"> <i>(Opcional)</i> Desea establecer un estado de autenticación en este visitante. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Dadas estas condiciones, realice una llamada al servicio de ID que incluya: </p> 
    <ul id="ul_9ECB1A65266644E89E949C57D202D5A4"> 
     ...
     <li id="li_4869572B40E54C54B88A2474DAC475A8">Su ID de proveedor de datos. Se trata de un ID exclusivo asignado a la compañía. Llamemos a esta ID 4444. </li> 
  ...
  <tr> 
   <td colname="col1"> <p> <b>Muestra de código y solución</b> </p> </td> 
   <td colname="col2"> <p>Dé formato a la llamada al servicio de ID de este modo: </p> <p> <span class="codeph">https://dpm.demdex.net/id?d_mid=1234&amp;d_cid=4444%019876%011&amp;d_ver=2</span> </p> <p>Observe cómo la llamada de ejemplo contiene el: </p> 
...
<table id="table_666A92693F8A413096DF6A64770C1141"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Este caso de uso supone que: </p> 
    <ul id="ul_BF3BD821907B46A4B2EFA63146D35722"> 
     <li id="li_E658AE0671D14558B65FDD8992F25996">No tenga un MID para el visitante del sitio. </li> 
     <li id="li_28A48BB3F71C4E4297F95A2D3E10AD7B">Necesita solicitar un MID del servicio de ID. </li> 
  ...
  <tr> 
   <td colname="col1"> <p> <b>Acciones</b> </p> </td> 
   <td colname="col2"> <p>Dadas estas condiciones, realice una llamada al servicio de ID que incluya su identificador de organización. </p> <p>Y, si ocurre que tiene cualquiera de los otros parámetros enumerados en la <a href="../implementation-guides/direct-integration.md#concept-4cd3206a84bb4687af0b312ae09648b9" format="dita" scope="local">guía de integración directa</a> (por ejemplo, <span class="codeph">d_blob</span> o <span class="codeph">dcs_region</span>, etc.) también es correcto transferirlos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Muestra de código y solución</b> </p> </td> 
   <td colname="col2"> <p>Dé formato a la llamada al servicio de ID de este modo: </p> <p> <span class="codeph">https://dpm.demdex.net/id?d_orgid=5555&amp;d_ver=2</span> </p> <p>Observe cómo la llamada de ejemplo contiene su ID de organización, <span class="codeph">d_orgid=5555</span>. Devolvería un <span class="keyword">Experience Cloud</span> ID para este visitante. </p> </td> 
  </tr> 
 </tbody> 
</table>
