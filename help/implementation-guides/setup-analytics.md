...
# Implementación del servicio de identidad de Experience Platform para Analytics {#implement-the-experience-cloud-id-service-for-analytics}
...
Consulte [, Prueba y verificación del servicio de identidad de Experience Platform](../implementation-guides/test-verify.md).
