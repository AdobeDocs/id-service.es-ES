...
+ [Puntos de decisión para la migración del servicio de identidad de la plataforma de experiencia](migration-decisions.md)
+ [Escenarios de migración de servicios de identidad de la plataforma de experiencia](migration-scenarios.md)
+ [Solicitudes de ID de Analytics y Experience Cloud](legacy-analytics.md)
+ [CNAME de recopilación de datos y seguimiento entre dominios](cname.md)
