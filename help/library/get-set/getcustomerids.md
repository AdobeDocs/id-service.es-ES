---
description: getCustomerIDs devuelve todos los ID de cliente establecidos por el servicio de ID de visitante.
...
getCustomerIDs devuelve todos los ID de cliente establecidos por el servicio de ID de visitante.
