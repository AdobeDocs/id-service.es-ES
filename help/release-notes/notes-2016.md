...
>[!IMPORTANT]
>
>La versión 1.6.0 del servicio de ID [!DNL Experience Cloud] *requiere* AppMeasurement para JavaScript versión 1.6.2. Si actualiza al servicio de ID versión 1.6.0, asegúrese de que está empleando la versión de código AppMeasurement correcta.
