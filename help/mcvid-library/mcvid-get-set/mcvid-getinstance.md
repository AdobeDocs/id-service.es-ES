...
>[!CAUTION]
>
>*No* cree instancias de la función Visitante con `var visitor = new Visitor`. Debe utilizar la función de llamada adecuada que se indica aquí. Se aplica a la [!DNL VisitorAPI.js] biblioteca de códigos v3.0 o posterior.
