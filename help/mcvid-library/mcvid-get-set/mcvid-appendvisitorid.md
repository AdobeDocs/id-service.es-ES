...
<ul class="simplelist"> 
 ...
 <li>  Compatibilidad con <a href="../../mcvid-library/mcvid-get-set/mcvid-appendvisitorid.md#section-168e313df6054af0a7e27b9fa0d69640" format="dita" scope="local">Dynamic Tag Management (DTM) y SDK </a> </li> 
</ul>
...
El servicio de ID escribe una cookie de origen y de terceros en el explorador cuando una persona visita su sitio (consulte [Cookies y el servicio](../../mcvid-introduction/mcvid-cookies.md) Experience Cloud ID). La cookie de origen contiene el MID, un ID único para el visitante en cuestión. La cookie de terceros contiene otro ID utilizado por el servicio de ID para generar el MID. Cuando un navegador bloquea esta cookie de terceros, el servicio de ID no puede:
