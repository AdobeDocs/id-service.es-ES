---
description: Llame a estas funciones del servicio de ID para determinar el estado de tiempo de espera de una solicitud de ID del servicio Experience Cloud ID, Analytics o Audience Manager. Disponible en VisitorAPI.js versión 1.7.0 o posteriores.
keywords: Servicio de ID
seo-description: Llame a estas funciones del servicio de ID para determinar el estado de tiempo de espera de una solicitud de ID del servicio Experience Cloud ID, Analytics o Audience Manager. Disponible en VisitorAPI.js versión 1.7.0 o posteriores.
...
Llame a estas funciones del servicio de ID para determinar el estado de tiempo de espera de una solicitud de ID del servicio Experience Cloud ID, Analytics o Audience Manager. Disponible en VisitorAPI.js versión 1.7.0 o posteriores.
